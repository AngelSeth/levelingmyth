...
public class PantherModel<T extends PantherEntity> extends SinglePartEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		.uv(48, 4).cuboid(1.0F, -22.0F, -15.0F, 2.0F, 2.0F, 2.5F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData frontlegBL = frontLegL.addChild("frontlegBL", ModelPartBuilder.create().uv(0, 27).cuboid(-1.0F, 2.5F, 5.25F, 2.0F, 3.0F, 2.0F, new Dilation(0.0F))
		.uv(44, 0).cuboid(-1.0F, 5.5F, 4.25F, 2.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(-1.9F, 8.4164F, -2.8379F));
